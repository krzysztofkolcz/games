...
import com.platformer04.gamestate.*;
...
public class GamePanel extends JPanel implements Runnable, KeyListener{
  ...
  public GamePanel(){
    ...
    System.out.println("game panel");
		setPreferredSize(new Dimension(Const.WIDTH * Const.SCALE , Const.HEIGHT * Const.SCALE ));
		setFocusable(true);
		requestFocus();
  }
  ...
  private void init() {
	...
	private void drawToScreen() {
		...
		g2.drawImage(image, 0, 0, Const.WIDTH * Const.SCALE , Const.HEIGHT * Const.SCALE , null);
		g2.dispose();
	}
